%#!lualatex
\documentclass[11pt,pdfa]{MishoText}
\usepackage{lipsum}
...
\end{equation}
\begin{equation}
 \hat{\bar{x}} + \overline{\acute{y}} = ☉♁☾⛢♂+\hat{x}\hat{y}\hat{z}\tilde\phi
\end{equation}
\begin{equation}
  ...
  \tilde a\tilde b\tilde c\tilde d\tilde e\tilde f\tilde A\tilde B\tilde C\tilde D\tilde E\tilde F
\end{equation}
\begin{equation}
  \tilde{\hat a}\tilde{\hat b}\tilde{\hat c}\tilde{\hat d}\tilde{\hat e}\tilde{\hat f}\tilde{\hat A}\tilde{\hat B}\tilde{\hat C}\tilde{\hat D}\tilde{\hat E}\tilde{\hat F}
  \bar{\tilde a}\bar{\tilde b}\bar{\tilde c}\bar{\tilde d}\bar{\tilde e}\bar{\tilde f}\bar{\tilde A}\bar{\tilde B}\bar{\tilde C}\bar{\tilde D}\bar{\tilde E}\bar{\tilde F}
\end{equation}
\section{Notes}
\lipsum[1]
